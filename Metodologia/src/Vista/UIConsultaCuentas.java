			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				else
				{
					...
					else
					{
						...
						modelo.clear();
						System.out.println(listaDeEmpresas.size());
						...
						for (int i = 0; i <listaDeEmpresas.size(); i++)
						   {
							...
							modelo.addElement(cuenta.findCtaPorEmpresa(listaDeEmpresas,comboDesde.getSelectedItem().toString(),comboHasta.getSelectedItem().toString(), comboEmpresa.getSelectedItem().toString()).get(i).getPeriodo().get(i).getValorCuenta());
