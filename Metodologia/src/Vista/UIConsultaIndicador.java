		...
		getContentPane().add(contentPanel, BorderLayout.CENTER);
		{
			...
			btnConsultar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					UIIndicadorPredef indicador= new UIIndicadorPredef(listaDeEmpresas,empresa,comboDesde.getSelectedItem().toString(),comboHasta.getSelectedItem().toString(),comboEmpresa.getSelectedItem().toString());
					indicador.show();
				}
			});
